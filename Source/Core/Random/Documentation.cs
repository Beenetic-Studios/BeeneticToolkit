namespace BeeneticToolkit {
    ...
    namespace Random {
        ...
        /// <summary>
        /// The <see cref="Random"/> namespace provides utilities for generating random numbers,
        ...
        /// <item><description><see cref="Generators.LCG"/> - Implements a standard Linear Congruential Generator for random number generation.</description></item>
        /// <item><description><see cref="Generators.MiddleSquare"/> - Implements the Middle Square Weyl Sequence algorithm for random number generation.</description></item>
        /// <item><description><see cref="Generators.Xorshift"/> - Implements the Xorshift algorithm for fast and efficient random number generation.</description></item>
        /// </list>
        /// </remarks>
