...
namespace BeeneticToolkit.Random {
    ...
    /// by either string key or <see cref="RngKey"/> while keeping them scoped to a specific environment.
    /// </para>
    /// <para>
    ...
    public sealed class RngEnvironment {
        ...
        /// but may be reassigned through <see cref="SetCurrent(string)"/> or <see cref="SetCurrent(RngKey)"/>.
        /// </para>
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Registers a random number generator under a specific <see cref="RngKey"/>.
        /// If a generator was previously registered with the same key, it will be replaced.
        /// </summary>
        ...
        /// If <see cref="Current"/> has not yet been assigned, it will be set to the newly registered generator.
        /// </remarks>
        public void Register(RngKey key, RandomGenerator generator) =>
        ...
        /// <summary>
        /// Creates a new random number generator, registers it under the specified <see cref="RngKey"/>,
        /// and returns the created instance.
        /// If a generator was previously registered with the same key, it will be replaced.
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="Current"/> random number generator to the one
        /// associated with the specified <see cref="RngKey"/>.
        /// </summary>
