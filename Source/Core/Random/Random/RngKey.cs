...
namespace BeeneticToolkit.Random {
    ...
    /// within an <see cref="RngEnvironment"/>.
    /// </summary>
    /// <remarks>
    /// <see cref="RngKey"/> provides a readable and reusable alternative to raw string keys
    /// while still allowing interoperability with APIs that accept string values.
    /// </remarks>
    public readonly struct RngKey : IEquatable<RngKey> {
        ...
        /// </value>
        /// <remarks>
        /// Because <see cref="RngKey"/> is a struct, a default instance can exist with a null value.
        /// </remarks>
        public bool IsEmpty => string.IsNullOrWhiteSpace(Value);

        /// <summary>
        /// Initializes a new instance of the <see cref="RngKey"/> struct.
        /// </summary>
        /// <param name="value">The string value for the key.</param>
        /// <exception cref="ArgumentException">
        /// Thrown when <paramref name="value"/> is null, empty, or whitespace.
        /// </exception>
        public RngKey(string value) {
            if (string.IsNullOrWhiteSpace(value))
                throw new ArgumentException("RngKey value cannot be null or whitespace.", nameof(value));
        ...
        /// <summary>
        /// Determines whether the current key is equal to another <see cref="RngKey"/>.
        /// </summary>
        ...
        /// </returns>
        public bool Equals(RngKey other) =>
        ...
        /// <returns>
        /// <see langword="true"/> if <paramref name="obj"/> is an <see cref="RngKey"/>
        /// with the same value; otherwise, <see langword="false"/>.
        /// </returns>
        public override bool Equals(object obj) =>
            obj is RngKey other && Equals(other);
        ...
        /// <summary>
        /// Determines whether two <see cref="RngKey"/> values are equal.
        /// </summary>
        ...
        /// </returns>
        public static bool operator ==(RngKey left, RngKey right) => left.Equals(right);

        /// <summary>
        /// Determines whether two <see cref="RngKey"/> values are not equal.
        /// </summary>
        /// <param name="left">The first key to compare.</param>
        /// <param name="right">The second key to compare.</param>
        /// <returns>
        ...
        /// <summary>
        /// Converts an <see cref="RngKey"/> to its underlying string value.
        /// </summary>
        /// <param name="key">The key to convert.</param>
        public static implicit operator string(RngKey key) => key.Value;

        /// <summary>
        /// Converts a string value to an <see cref="RngKey"/>.
        /// </summary>
        /// <param name="value">The string value to convert.</param>
        /// <exception cref="ArgumentException">
        /// Thrown when <paramref name="value"/> is null, empty, or whitespace.
        /// </exception>
        public static explicit operator RngKey(string value) => new RngKey(value);
    }
}