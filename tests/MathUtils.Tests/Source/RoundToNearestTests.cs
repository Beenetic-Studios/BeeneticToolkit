...
namespace BeeneticToolkit.MathUtils {
    ...
    public class RoundToNearestTests {
        ...
        public void RoundToNearestFloat_StandardCase() {
            ...
            float interval = 1f;
            float expected = 5f;
            float result = MathUtils.RoundToNearest(value, interval);
        ...
        public void RoundToNearestDouble_StandardCase() {
            ...
            double interval = 1d;
            double expected = 5d;
            double result = MathUtils.RoundToNearest(value, interval);
            Assert.AreEqual(expected, result, "RoundToNearest should round the value to the nearest interval.");
        }
        ...
        public void RoundToNearestDecimal_StandardCase() {
            ...
            decimal interval = 1m;
            decimal expected = 5m;
            decimal result = MathUtils.RoundToNearest(value, interval);
            Assert.AreEqual(expected, result, "RoundToNearest should round the value to the nearest interval.");
        }
