...
<a name='BeeneticToolkit.Random.IRandomGenerator.NextBytes(int,byte,byte).min'></a>
...
<a name='BeeneticToolkit.Random.IRandomGenerator.NextBytes(int,byte,byte).max'></a>
