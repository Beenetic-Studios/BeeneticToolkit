...
## FileLogger.Log(LogSeverity, string) Method
...
<a name='BeeneticToolkit.Logging.FileLogger.Log(BeeneticToolkit.Logging.LogSeverity,string).severity'></a>

`severity` [LogSeverity](LogSeverity.md 'BeeneticToolkit.Logging.LogSeverity')

The severity level of the log message.

<a name='BeeneticToolkit.Logging.FileLogger.Log(BeeneticToolkit.Logging.LogSeverity,string).message'></a>
