...
## EnumItemMetadataBase.IsReadOnly Property

Gets a value indicating whether the metadata is readonly.

```csharp
public bool IsReadOnly { get; }
```

Implements [IsReadOnly](IHasMetadata_T_.IsReadOnly.md 'BeeneticToolkit.Collections.Enums.Metadata.IHasMetadata<T>.IsReadOnly')
