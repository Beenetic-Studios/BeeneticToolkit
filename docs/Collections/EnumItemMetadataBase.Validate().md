...
## EnumItemMetadataBase.Validate() Method

Validates the metadata instance to ensure all required properties are set.
...
Thrown if the metadata is in an invalid state.