...
## EnumCollection<T,TKey,TGroup>.RemoveRange(IEnumerable<T>) Method
...
<a name='BeeneticToolkit.Collections.Enums.EnumCollection_T,TKey,TGroup_.RemoveRange(System.Collections.Generic.IEnumerable_T_).items'></a>
...
### Remarks
This method calls [Remove(T)](EnumCollection_T,TKey,TGroup_.Remove(T).md 'BeeneticToolkit.Collections.Enums.EnumCollection<T,TKey,TGroup>.Remove(T)') for each item in the provided collection.