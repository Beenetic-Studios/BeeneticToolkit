...
## EnumItemMetadataBase.MarkAsReadOnly() Method

Marks the metadata as readonly, preventing further modifications.

```csharp
public void MarkAsReadOnly();
```

Implements [MarkAsReadOnly()](IHasMetadata_T_.MarkAsReadOnly().md 'BeeneticToolkit.Collections.Enums.Metadata.IHasMetadata<T>.MarkAsReadOnly()')