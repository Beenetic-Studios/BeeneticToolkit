...
| [Key](EnumItem_TGroup_.Key.md 'BeeneticToolkit.Collections.Enums.EnumItem<TGroup>.Key') | Gets the unique key identifying this enumeration item. |
...
| [Equals(object)](EnumItem_TGroup_.Equals(object).md 'BeeneticToolkit.Collections.Enums.EnumItem<TGroup>.Equals(object)') | Determines whether the specified object is equal to the current enumeration item, based on its key and type. |
