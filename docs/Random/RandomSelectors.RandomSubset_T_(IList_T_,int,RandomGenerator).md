...
<a name='BeeneticToolkit.Random.Utilities.RandomSelectors.RandomSubset_T_(System.Collections.Generic.IList_T_,int,BeeneticToolkit.Random.RandomGenerator).T'></a>
...
<a name='BeeneticToolkit.Random.Utilities.RandomSelectors.RandomSubset_T_(System.Collections.Generic.IList_T_,int,BeeneticToolkit.Random.RandomGenerator).list'></a>

`list` [System.Collections.Generic.IList&lt;](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.IList-1 'System.Collections.Generic.IList`1')[T](RandomSelectors.RandomSubset_T_(IList_T_,int,RandomGenerator).md#BeeneticToolkit.Random.Utilities.RandomSelectors.RandomSubset_T_(System.Collections.Generic.IList_T_,int,BeeneticToolkit.Random.RandomGenerator).T 'BeeneticToolkit.Random.Utilities.RandomSelectors.RandomSubset<T>(System.Collections.Generic.IList<T>, int, BeeneticToolkit.Random.RandomGenerator).T')[&gt;](https://docs.microsoft.com/en-us/dotnet/api/System.Collections.Generic.IList-1 'System.Collections.Generic.IList`1')

The list from which to select a random subset.

<a name='BeeneticToolkit.Random.Utilities.RandomSelectors.RandomSubset_T_(System.Collections.Generic.IList_T_,int,BeeneticToolkit.Random.RandomGenerator).subsetSize'></a>
...
<a name='BeeneticToolkit.Random.Utilities.RandomSelectors.RandomSubset_T_(System.Collections.Generic.IList_T_,int,BeeneticToolkit.Random.RandomGenerator).random'></a>
