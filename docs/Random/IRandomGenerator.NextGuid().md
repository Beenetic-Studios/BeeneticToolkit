...
## IRandomGenerator.NextGuid() Method

Generates a [System.Guid](https://docs.microsoft.com/en-us/dotnet/api/System.Guid 'System.Guid') populated with random bytes (non-cryptographic).
