...
## RandomGenerator.NextInt(int) Method
...
<a name='BeeneticToolkit.Random.RandomGenerator.NextInt(int).maxExclusive'></a>
...
A random integer in the range [0, [maxExclusive](RandomGenerator.NextInt(int).md#BeeneticToolkit.Random.RandomGenerator.NextInt(int).maxExclusive 'BeeneticToolkit.Random.RandomGenerator.NextInt(int).maxExclusive')).
