...
```csharp
public BeeneticToolkit.Random.RandomGenerator CreateAndRegister(BeeneticToolkit.Random.RngKey key, System.Nullable<long> seed=null, BeeneticToolkit.Random.RngAlgorithm algorithm=BeeneticToolkit.Random.RngAlgorithm.Xoshiro256);
```
#### Parameters
