...
## RandomEnvironment.Register(string, RandomGenerator) Method
...
<a name='BeeneticToolkit.Random.RandomEnvironment.Register(string,BeeneticToolkit.Random.RandomGenerator).key'></a>

`key` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

The key to associate with the generator.

<a name='BeeneticToolkit.Random.RandomEnvironment.Register(string,BeeneticToolkit.Random.RandomGenerator).generator'></a>
