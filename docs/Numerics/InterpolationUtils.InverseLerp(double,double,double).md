...
## InterpolationUtils.InverseLerp(double, double, double) Method
...
<a name='BeeneticToolkit.Numerics.InterpolationUtils.InverseLerp(double,double,double).value'></a>

`value` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

The current value.

<a name='BeeneticToolkit.Numerics.InterpolationUtils.InverseLerp(double,double,double).min'></a>

`min` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

The start value.

<a name='BeeneticToolkit.Numerics.InterpolationUtils.InverseLerp(double,double,double).max'></a>
