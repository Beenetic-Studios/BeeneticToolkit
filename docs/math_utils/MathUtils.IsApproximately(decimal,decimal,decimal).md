...
## MathUtils.IsApproximately(decimal, decimal, decimal) Method
...
<a name='BeeneticToolkit.MathUtils.MathUtils.IsApproximately(decimal,decimal,decimal).value'></a>

`value` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The first value to compare.

<a name='BeeneticToolkit.MathUtils.MathUtils.IsApproximately(decimal,decimal,decimal).other'></a>

`other` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The second value to compare.

<a name='BeeneticToolkit.MathUtils.MathUtils.IsApproximately(decimal,decimal,decimal).tolerance'></a>
